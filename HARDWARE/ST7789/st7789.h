...
/* Basic operations */
#define ST7789_RST_Clr() 		GPIO_WriteBit(ST7789_RST_PORT, ST7789_RST_PIN, Bit_RESET)
#define ST7789_RST_Set() 		GPIO_WriteBit(ST7789_RST_PORT, ST7789_RST_PIN, Bit_SET)
