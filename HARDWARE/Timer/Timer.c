...
*                                              内部变量
*********************************************************************************************************/
static  u8  s_i2msFlag  = FALSE;       //2ms	标志设置为 FALSE
static  u8  s_i50msFlag = FALSE;       //50ms   标志设置为 FALSE
...
*********************************************************************************************************/
void InitTimer(void) {
    ConfigTimer2(999, 99);  //100MHz /（99 + 1） = 1MHz，由0计数到999为1ms
    ConfigTimer5(999, 99);  //100MHz /（99 + 1） = 1MHz，由0计数到999为1ms
}
...
* 注    意:
*********************************************************************************************************/
void  Clr50msFlag(void) {
    s_i50msFlag = FALSE;    //将1s标志设置为FALSE
}
